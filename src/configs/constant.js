...
export const GOOGLE_API_KEY = "AIzaSyAmqoMs0zfgyEIO24FEwTKb2cm-HVUzC-A";
...
export const TEA_LEAVES_ROUTE = BASE_ROUTE_PATH + "tea-leaves";
export const STOCK_ROUTE = BASE_ROUTE_PATH + "stock";
export const ADVANCE_ROUTE = BASE_ROUTE_PATH + "advance";
export const PAYMENTS_ROUTE = BASE_ROUTE_PATH + "payments";
